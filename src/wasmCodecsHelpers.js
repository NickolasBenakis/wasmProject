...
export const encodeOnixPng = async (image, opts) => {
  const defaultOpts = {
    level: 2,
    module: {
      pngEncDecJs: '../codecs/png/pkg.._png.js',
      oxipngEncJs: '../codecs/oxipng/pkg.._oxipng.js',
      squooshPngBgWasm: '../codecs/png/pkg.._png_bg.wasm',
      squooshOxipngBgWasm: '../codecs/oxipng/pkg.._oxipng_bg.wasm',
    },
  };
...
export const resizePixelImage = async (image, opts) => {
  ...
  const defaultOpts = {
    factor: 2,
    module: {
      squooshhqxJs: '../codecs/hqx/pkg..hqx.js',
      squooshhqxBgWasm: '../codecs/hqx/pkg..hqx_bg.wasm',
    },
  };
...
export const resizeImage = async (
  ...
  const defaultOpts = {
    ...
    linearRGB: true,
    module: {
      squooshResizeJs: '../codecs/resize/pkg.._resize.js',
      squooshResizeBgWasm: '../codecs/resize/pkg.._resize_bg.wasm',
    },
  };
